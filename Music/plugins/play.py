...
fotoplay = "https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg"
ngantri = "https://te.legra.ph/file/18b5cd1061adfe09f7459.jpg"
from Music import call_py, Zaid, client as Client
owner = "1420377975"
from Music.helpers.yt_dlp import bash
from Music.helpers.chattitle import CHAT_TITLE
from Music.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Music.helpers.thumbnail import gen_thumb
from Music.helpers.joiner import AssistantAdd
...
@Music.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):

     await event.delete()

btnn =[
    [Button.url("💁 Sᴜᴘᴘᴏʀᴛ", url=f"t.me/{MyBotsupport}"), Button.url("Cʜᴀɴɴᴇʟ 🙋", url=f"t.me/{MyBotsupport}")],
    [Button.inline("Cʟᴏꜱᴇ 🗑️", data="cls")]]


#play
@Music.on(events.NewMessage(pattern="^[?!/]play"))
@AssistantAdd
...
#end
@Music.on(events.NewMessage(pattern="^[/?!]end"))
@is_admin
...
@Music.on(events.NewMessage(pattern="^[?!/]vplay"))
@AssistantAdd
...
#playlist
@Music.on(events.NewMessage(pattern="^[?!/]playlist"))
@is_admin
...
#leavevc
@Music.on(events.NewMessage(pattern="^[?!/]leavevc"))
@is_admin
...
@Music.on(events.NewMessage(pattern="^[?!/]skip"))
@is_admin
...
@Music.on(events.NewMessage(pattern="^[?!/]pause"))
@is_admin
...
@Music.on(events.NewMessage(pattern="^[?!/]resume"))
@is_admin
